export const products = [
    ...
    { 
        ...
        quantity: 1,
        description: 'New Hair Dryer for Men and Women 2 Speed Heat Settings Button with AC Motor, Concentrator Nozzle and Removable Filter (1800W)Advanced concentrator technology with quick-heat head Heavy duty motor with very little noise overheat protection True cold shot includes fast dry and super slim precision styling concentrators diffuser 1800 w Long life Dc motorm, Note - If the appliance overheats, Unplug the appliance and let it cool down for a few minutes. Before you switch the appliance on again, check the grilles to make sure they are not blocked by fluff, hair, Etc',
        discount: 'From ₹499', 
